...
def load_response_data(time_filter, municipality, date=None, week_start=None):
    try:
        ...
        query = "SELECT * FROM pnp_response WHERE barangay IN (SELECT barangay FROM users WHERE assigned_municipality = ?)"
        params = [municipality]
...
def get_pnp_analytics_data(responses, time_filter='today', municipality='', date=None, week_start=None):
    try:
        ...
        if time_filter == 'weekly' and week_start:
            ...
            return {
                'trends': get_pnp_trends(time_filter, municipality, date, week_start),
                'distribution': get_pnp_distribution(time_filter, municipality, date, week_start),
                'causes': get_pnp_causes(time_filter, municipality, date, week_start),
                'types': get_pnp_types(time_filter, municipality, date, week_start),
                'road_conditions': get_pnp_road_conditions(time_filter, municipality, date, week_start),
                'weather': get_pnp_weather(time_filter, municipality, date, week_start),
                'vehicle_types': get_pnp_vehicle_types(time_filter, municipality, date, week_start),
                'driver_age': get_pnp_driver_age(time_filter, municipality, date, week_start),
                'driver_gender': get_pnp_driver_gender(time_filter, municipality, date, week_start),
                'dates': dates,
                'summary': summary
            }
        return {
...
def get_pnp_trends(time_filter, municipality='', date=None, week_start=None):
    try:
        df = load_response_data(time_filter, municipality, date, week_start)
...
def get_pnp_distribution(time_filter, municipality='', date=None, week_start=None):
    try:
        df = load_response_data(time_filter, municipality, date, week_start)
...
def get_pnp_causes(time_filter, municipality='', date=None, week_start=None):
    try:
        df = load_response_data(time_filter, municipality, date, week_start)
...
def get_pnp_types(time_filter, municipality='', date=None, week_start=None):
    try:
        df = load_response_data(time_filter, municipality, date, week_start)
...
def get_pnp_road_conditions(time_filter, municipality='', date=None, week_start=None):
    try:
        df = load_response_data(time_filter, municipality, date, week_start)
...
def get_pnp_weather(time_filter, municipality='', date=None, week_start=None):
    try:
        df = load_response_data(time_filter, municipality, date, week_start)
...
def get_pnp_vehicle_types(time_filter, municipality='', date=None, week_start=None):
    try:
        df = load_response_data(time_filter, municipality, date, week_start)
...
def get_pnp_driver_age(time_filter, municipality='', date=None, week_start=None):
    try:
        df = load_response_data(time_filter, municipality, date, week_start)
...
def get_pnp_driver_gender(time_filter, municipality='', date=None, week_start=None):
    try:
        df = load_response_data(time_filter, municipality, date, week_start)
