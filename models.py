...
arima_m = None
try:
    arima_m = joblib.load(os.path.join(os.path.dirname(__file__), 'training', 'Road Models', 'monthly_arima80_20.pkl'))
...
arima_22 = None
try:
    arima_22 = joblib.load(os.path.join(os.path.dirname(__file__), 'training', 'Road Models', 'forecast_80_20.pkl'))
...
arima_pred = None
try:
    arima_pred = joblib.load(os.path.join(os.path.dirname(__file__), 'training', 'Road Models', 'arima70_15_15.pkl'))
